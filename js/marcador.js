marcadorModulo = (function () {
  ...
  function mostrarMiMarcador (ubicacion) {
    // Objeto marker de google.maps que tiene ubicacion como parametro + animaciones
    ...
    miMarcador.addListener("dragend", nuevoMarcador)
    function nuevoMarcador(e){
    // agregar respuesta de evento dragend
  ...
  function agregarMarcadorRuta (direccion, letra, esInicial) {
    ...
    // Marca los lugares que están en el array resultados y
